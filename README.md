...
6. "No-news is good-news." From 'the emperor has no clothes' (a lesson even young children can understand) to potemkin-villages (a trap adults find it difficult to avoid), a more general perennial and universal problem is an opposition to data, testing, and the value, function, and meaning of STEM in principle. For whatever reasons, historically there is an overwhelmingly fierce opposition to data and STEM. This book review articulates some examples that should be recognizable to most people,
https://www.economist.com/culture/2026/07/03/inside-the-fantasy-world-of-donald-trump.  Definition-Behavior studies (https://github.com/lineality/definition_behavior_studies) may be part of untangling how these common problems develop, but whether or not we are ready to map the disorder the phenomena itself should be recognized.
